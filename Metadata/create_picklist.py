...
with TM1Service(**config['tm1srv03']) as tm1:
    ...
    if not(tm1.cubes.exists('}PickList_'+ dimension_name)):
        ...
        rules = "SKIPCHECK;\n"\
                ...
                "\n"\
                "FEEDERS;"
        picklist_cube = TM1py.Cube('}PickList_'+ dimension_name,[context_dim,dimension_name,'}Picklist'],rules=rules)                       # create cube object
        tm1.cubes.create(picklist_cube)                                                                                                     # create cube int tm1 from cube object
